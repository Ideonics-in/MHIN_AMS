...
namespace PMAlerter
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Receivers.Add(new Receiver { Email = "Pradeep.P@mann-hummel.com", Level = 1 });
            //Receivers.Add(new Receiver { Email = "Saji.Kumar@mann-hummel.com", Level = 2 });
            ...
            using (var db = new AMSDB())
            {
                var assets = from a in db.Assets
                             where a.Department == "Maintenance"
                             select a;
